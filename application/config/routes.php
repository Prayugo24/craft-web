...
$route['craftsmen'] = 'CraftsMenController';
$route['terms-and-conditions'] = 'TermsConditionsController';
...
// admin
$route['super-power'] = 'admin/AuthController/login';
$route['dashboard'] = 'admin/DashboardController';
$route['dashboard-product'] = 'admin/ProductController';
$route['proforma-invoice'] = 'admin/ProformaInvoiceController/laporan_pdf';
$route['dashboard-invoice'] = 'admin/InvoiceController';
